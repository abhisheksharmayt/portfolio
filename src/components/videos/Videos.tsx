        ...
        <main>
            <section className='video-portfolio-section'>
                <div className="video-intro-div">
                    ...
                    <h4 className='info'>An undergrad who loves to edit videos and knows how to make them <span className='hightlight'>engaging</span></h4>
                </div>
                                ...
                                return (
                                    <div key={id} className="client-card">
                                        ...
                                        <Link to={`/videos/${link_params}`}>
                                                <HiExternalLink style={{ color: '#eee', height: '30px', width: '30px' }} />
                                        </Link>
                                            </div>
